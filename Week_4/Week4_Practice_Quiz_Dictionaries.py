...
print(groups_per_user({"local": ["admin", "userA"], "public": ["admin", "userB"], "administrator": ["admin"]}))  # Should print: {'admin': ['local', 'public', 'administrator'], 'userA': ['local'], 'userB': ['public']}
...
print(wardrobe.items())  # Should print: dict_items([('shirt', ['red', 'blue', 'white']), ('jeans', ['white']), ('scarf', ['yellow']), ('socks', ['black', 'brown'])])
